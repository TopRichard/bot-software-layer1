...
BIND_PATHS="$EESSI_TMPDIR/var-run-cvmfs:/var/run/cvmfs,$EESSI_TMPDIR/var-lib-cvmfs:/var/lib/cvmfs,$EESSI_TMPDIR,/etc/cvmfs/default.local:/etc/cvmfs/default.local"
echo $BIND_PATHS
